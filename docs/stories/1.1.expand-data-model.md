...
- [x] Task 1: Update Album model in models.py (AC: 2)
...
- [x] Task 2: Set up Alembic migration system (AC: 1, 6)
...
- [x] Task 3: Create database migration script (AC: 1, 2, 4)
...
- [x] Task 4: Update Pydantic schemas in schemas.py (AC: 3)
...
- [x] Task 5: Apply database migration (AC: 4, 6)
...
- [x] Task 6: Update main.py startup to use Alembic instead of create_all (AC: 5)
